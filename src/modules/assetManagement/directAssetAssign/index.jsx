...
const DirectAssetAssignLanding = () => {
  ...
  const [, deleteDirectAsset, deleteDirectAssetLoading] = useAxiosPost({});
  const [directAssetAssignLanding, getDirectAssetAssignLanding, loading] =
    useAxiosGet([]);
  ...
  return (
    <>
      <>
        {(loading || deleteDirectAssetLoading) && <Loading />}
        {permission?.isView ? (
          <>
                    ...
                    <li>
                      <ResetButton
                        ...
                        onClick={() => {
                          ...
                          setRowDto(directAssetAssignLanding);
                        }}
                      />
                    </li>
                  )}
                  ...
                  <li>
                    <PrimaryButton
                      ...
                      onClick={() => {
                        ...
                        history.push(
                          `/assetManagement/assetAssign/directAssign/create`
                        );
                      }}
                    />
                  </li>
                ...
                <>
                  <div className="table-card-body">
                    <div className="table-card-styled employee-table-card table-responsive ant-scrolling-Table">
                      <AntTable
                        data={rowDto}
                        columnsData={directAssetAssignTableColumn(
                          history,
                          deleteDirectAsset,
                          () => {
                            onGetAssetDirectAssignLanding(
...
export default DirectAssetAssignLanding;
