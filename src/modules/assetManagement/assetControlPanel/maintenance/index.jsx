...
import { assetMaintenanceColumn, getData } from "./utils";
        ...
        <div className="table-card">
          <div className="table-card-heading">
            <div className="d-flex align-items-center">
              <h6 className="count">Asset Maintenance</h6>
            </div>
              ...
              <li>
                <PrimaryButton
                  ...
                  onClick={() => {
                    ...
                    history.push(
                      "/assetManagement/assetControlPanel/maintenance/create"
                    );
                  }}
                />
              </li>
          ...
          <div className="table-card-body">
            {rowDto?.length > 0 ? (
              <PeopleDeskTable
                columnData={assetMaintenanceColumn(
                  pages?.current,
                  pages?.pageSize
                )}
                onRowClick={(data) => {
