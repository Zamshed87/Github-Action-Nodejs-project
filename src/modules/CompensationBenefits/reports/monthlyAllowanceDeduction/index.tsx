...
const MonthlyAllowanceDeductionReport = () => {
  ...
  const submitHandler = () => {
    ...
    MonthlyAllowanceDeductionReportLanding("htmlView", values);
  };
  ...
  // Functions
  const MonthlyAllowanceDeductionReportLanding = (
    partName: string,
    values: any
  ) => {
    CostCenterReportLanding?.action({
      method: "get",
      urlKey: "MonthlyAllowanceDeduction",
      params: {
  ...
  document.title = "Monthly Allowance Deduction Report";
  return (
    <>
      <PForm
        form={form}
      ...
      >
        ...
        <PCard>
          <PCardHeader title="Monthly Allowance Deduction Report" />
...
export default MonthlyAllowanceDeductionReport;
