...
const getTableDataForExcel = (row) => {
  const data = row?.map((item, index) => {
    return [
      ...
      new Cell(item?.strEmployeeName, "left", "text").getCell(),
      // new Cell(item?.strEmployeeCode, "center", "text").getCell(),
      new Cell(item?.strDesignationName, "center", "text").getCell(),
      new Cell(item?.strEmploymentTypeName, "center", "text").getCell(),
      new Cell(item?.strServiceLength, "center", "text").getCell(),
...
export const generateBonusAction = (
  title,
  fromDate,
  toDate,
  column,
