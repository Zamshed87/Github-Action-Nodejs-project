              ...
              <th scope="col">
                <div
                  ...
                  onClick={() => {
                    ...
                    commonSortByFilter(salaryCodeOrder, "strSalaryCode");
                  }}
                >
                  Salary Code
            ...
            {applicationListData?.listData?.length > 0 &&
              applicationListData?.listData?.map((data, i) => (
                ...
                >
                  ...
                  <td onClick={() => singleViewData(data)}>
                    <p className="tableBody-title">{data?.strSalaryCode}</p>
                  </td>
                  <td onClick={() => singleViewData(data)}>
                    <div className="tableBody-title">
                      <div className="d-flex align-items-center ">
                        ...
                        <span className="content tableBody-title">
                          {getMonthName(data?.application?.intMonth)},
                          {data?.application?.intYear}
                        </span>
                      </div>
                    </div>
                  </td>
                  <td onClick={() => singleViewData(data)}>
                    <p className="tableBody-title">
                      {dateFormatter(data?.application?.dteUpdatedAt)}
                    </p>
                  </td>
                  {isOfficeAdmin && (
                    <td>
