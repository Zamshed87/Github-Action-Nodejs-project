...
const getTableData = (row) => {
  const data = row?.map((item, index) => {
    return [
      ...
      new Cell(item?.bankAccountNumber || "N/A", "left", "text").getCell(),
      ...
      new Cell(item?.financialInstitution, "center", "text").getCell(),
      new Cell(item?.branchName, "center", "text").getCell(),
      new Cell("EFTN", "left", "text").getCell(),
    ];
  });
  return data;
};

export const formatDBL = (
  comapanyNameHeader,
  tableHeader,
  tableData,
  fromDate,
    ...
    sheets: [
      {
        ...
        rows: [
          ...
          [
            ...
            {
              text: "Sender Acc. Number",
              fontSize: 7,
              bold: true,
              border: "all 000000 thin",
            },
            {
              text: "Receiving Bank Routing",
              fontSize: 7,
              bold: true,
              border: "all 000000 thin",
            },
