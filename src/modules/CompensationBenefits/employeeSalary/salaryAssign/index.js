                    ...
                    <tr>
                        ...
                        <div
                          ...
                          onClick={() => {
                            setWorkplaceGroupOrder(
                              workplaceGroupOrder === "desc" ? "asc" : "desc"
                            );
                            commonSortByFilter(
                              workplaceGroupOrder,
                              "WorkplaceGroupName"
                        ...
                        <>
                          <th>
                            <div
                              ...
                              onClick={() => {
                                setWingOrder(
                                  wingOrder === "desc" ? "asc" : "desc"
                                );
                                commonSortByFilter(wingOrder, "wingName");
                              }}
                            >
                              Wing
                              <div>
                          ...
                          <th>
                            <div
                              ...
                              onClick={() => {
                                setRegionOrder(
                                  regionOrder === "desc" ? "asc" : "desc"
                                );
                                commonSortByFilter(regionOrder, "regionName");
                              }}
                            >
                              Region
                              <div>
                                <SortingIcon
                                  viewOrder={regionOrder}
                                ></SortingIcon>
                              </div>
                            </div>
                          </th>
                          <th>
                            <div
                              ...
                              onClick={() => {
                                setAreaOrder(
                                  areaOrder === "desc" ? "asc" : "desc"
                                );
                                commonSortByFilter(areaOrder, "areaName");
                              }}
                            >
                              Area
                              <div>
                      ...
                      <th style={{ width: "110px" }}>
                        <div
                          className="d-flex align-items-center pointer"
                          onClick={() => {
                            setPerdaySalaryOrder(
                              perdaySalaryOrder === "desc" ? "asc" : "desc"
                            );
                            commonSortByFilter(
                              perdaySalaryOrder,
                              "PerdaySalary"
                      ...
                      <th style={{ width: "100px" }}>
                        <div
                          ...
                          onClick={() => {
                            setBasicSalaryOrder(
                              basicSalaryOrder === "desc" ? "asc" : "desc"
                            );
                            commonSortByFilter(
                              basicSalaryOrder,
                              "numBasicSalary"
                      ...
                      <th style={{ width: "110px" }}>
                        <div
                          ...
                          onClick={() => {
                            setGrossSalaryOrder(
                              grossSalaryOrder === "desc" ? "asc" : "desc"
                            );
                            commonSortByFilter(
                              grossSalaryOrder,
                              "numBasicORGross"
