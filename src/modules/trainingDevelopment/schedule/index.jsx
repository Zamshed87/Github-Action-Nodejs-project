...
const TrainingScheduleLanding = () => {
  ...
  const confirmation = (values) => {
    const payload = {
      ...singleData,
      DteCourseCompletionDate: values?.confirmDate,
      IntAccountId: orgId,
  ...
  const extention = (values) => {
    const payload = {
      ...singleData,
      dteExtentedDate: values?.extendDate,
      dteToDate: values?.extendDate,
      IntAccountId: orgId,
      IntBusinessUnitId: buId,
      intActionBy: employeeId,
    };
  ...
  const lastAssesment = (values) => {
    const payload = {
      ...singleData,
      dteLastAssesmentSubmissionDate: values?.lastAssesmentDate,
      IntAccountId: orgId,
      IntBusinessUnitId: buId,
      intActionBy: employeeId,
    };
