          ...
          <>
            ...
            <Form onSubmit={handleSubmit}>
                      ...
                      <>
                        <div className="table-card-styled employee-table-card tableOne  table-responsive mt-3">
                          <AntTable
                            data={rowDto || []}
                            removePagination
                            columnsData={adminWorkLineConfigCol(
                              permission,
                              setId,
                              setOpen
                            )}
              ...
              <AddEditFormComponent
                show={open}
                title={id ? "Edit Workline Config" : "Create Workline Config"}
                onHide={handleClose}
                size="lg"
                backdrop="static"
...
/*     <table className="table">
                          <thead>
                            <tr>
                              ...
                              <th>
                                <div className="sortable">
                                  <span>Service Length Days</span>
                                </div>
                              </th>
                              <th>
                                <div className="sortable">
                                  <span>Notify Days</span>
                                </div>
                              </th>
