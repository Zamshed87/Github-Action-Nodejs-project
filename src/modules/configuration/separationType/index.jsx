...
import { filterData, getSeparationType, separationDtoCol } from "./helper";
...
function SeparationType() {
  ...
  useEffect(() => {
    ...
    document.title = "Separation Type";
  }, []);
          ...
          <>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <AddEditFormComponent
                show={open}
                title={id ? "Edit Separation Type" : "Create Separation Type"}
                onHide={handleClose}
                size="lg"
                backdrop="static"
                classes="default-modal"
                              ...
                              <tr>
                                ...
                                <th>
                                  <div className="sortable">
                                    <span>Separation Type Name</span>
                                  </div>
                                </th>
                                <th>
                                  <div className="sortable">
