...
export default function AddEditForm({
  ...
  const saveSeparationType = useApiRequest({});
  ...
  const submitHandler = ({ values, resetForm, setIsAddEditForm }) => {
    ...
    let payload = {
      intSeparationTypeId: singleData?.intSeparationTypeId
        ? singleData?.intSeparationTypeId
        : 0,
      strSeparationType: values?.strSeparationType,
    ...
    saveSeparationType.action({
      urlKey: "SaveSeparationType",
      method: "POST",
      payload: payload,
      onSuccess: () => {
        cb();
  ...
  useEffect(() => {
    if (singleData?.intSeparationTypeId) {
      form.setFieldsValue({
        ...singleData,
      });
    }
      ...
      >
        <Row gutter={[10, 2]}>
          <Col md={24} sm={24}>
            <PInput
              type="text"
              name="strSeparationType"
              label="Separation Type"
              placeholder="Separation Type"
              rules={[
                { required: true, message: "Separation Type is required" },
              ]}
            />
          </Col>
          <Col md={12} sm={24}>
              ...
              >
                ...
                >
                  ...
                  <p className="subtitle-p">
                    Activation toggle indicates to the particular Separation
