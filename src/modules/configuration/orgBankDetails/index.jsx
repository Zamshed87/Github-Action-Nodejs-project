...
import OrgBankDetailsAddEditFormComponent from "./addEditForm";
import {
  filterData,
...
function OrgBankDetailsLanding() {
  ...
  const getLandingData = () => {
    getAllOrgBankDetailsLanding(orgId, buId, setRowDto, setAllData, setLoading);
  };
  ...
  return (
    <>
                      ...
                      <>
                        <div className="table-card-styled employee-table-card tableOne  table-responsive mt-3">
                          <AntTable
                            data={rowDto || []}
                            removePagination
                            columnsData={orgBankDetailsDtoCol(
                              permission,
                              setOpen,
                              setSingleData
                            )}
      ...
      {/* View Form Modal */}
      <OrgBankDetailsViewFormComponent
        show={viewModal}
        title={"View Org Bank Details"}
      ...
      />
      {/* addEdit form Modal */}
      <OrgBankDetailsAddEditFormComponent
        show={open}
        title={
          singleData?.intAccountBankDetailsId
            ? "Edit Org Bank Details"
            : "Create Org Bank Details"
        }
        onHide={handleClose}
        size="lg"
        backdrop="static"
