        ...
        <Row gutter={[5, 2]} style={{ marginBottom: "-1.2rem" }}>
          <div className=" d-flex align-items-center">
            ...
            <div className="modal-body-txt">
              <h6 className="title-item-name">{singleData?.strDocumentType}</h6>
              <p className="subtitle-p">{"Documentation Type"}</p>
            </div>
          </div>
        </Row>
      </PForm>
...
// import { getGlobalDocumentTypeById } from "../helper";
