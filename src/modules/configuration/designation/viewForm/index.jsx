...
export default function ViewFormComponent({
  ...
  const ddlListView = (array, property) => {
    let modifyArr = array?.map((itm) => itm[property]);
                          ...
                          <>
                            ...
                            >
                              ...
                              <div>
                                <h6 className="title-item-name">
                                  {singleData?.strDesignationCode || "N/A"}
                                </h6>
                            ...
                            <div className="modal-body-main d-flex align-items-center">
                              ...
                              <div>
                                <h6 className="title-item-name">
                                  {ddlListView(
                                    singleData?.businessUnitValuLabelVMList,
                                    "label"
                                  ) || "N/A"}
                                </h6>
                            ...
                            <div className="modal-body-main d-flex align-items-center">
                              <div style={{ marginRight: "17px" }}>
                                <Avatar sx={avatarSx}>
                                  <Person sx={{ color: "#616163" }} />
                                </Avatar>
                              </div>
                              <div>
                                <h6 className="title-item-name">
                                  {ddlListView(
                                    singleData?.roleValuLabelVMList,
                                    "label"
                                  ) || "N/A"}
                                </h6>
                                <p className="subtitle-p">User Role</p>
                              </div>
                            </div>
                            <div className="modal-body-main d-flex align-items-center">
                              <div style={{ marginRight: "17px" }}>
