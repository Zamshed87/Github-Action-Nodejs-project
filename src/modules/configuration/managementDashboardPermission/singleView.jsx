...
export default function ManagementDashboardPermissionDetails() {
              ...
              <div className="row">
                <div className="col-lg-3">
                  <CircleButton
                    ...
                    title={state?.businessUnitName || "-"}
                    subTitle="Business Unit Name"
                  />
                </div>
                  ...
                  <div className="salary-breakdown-details-table">
                    <div className="table-card-styled employee-table-card tableOne">
                      <table className="table">
                        ...
                        <tbody>
                          {state?.employeeManagementPermissionList?.length
                            ? state?.employeeManagementPermissionList?.map(
                                (item, index) => {
                                  return (
                                    <tr key={index}>
