...
export default function AddEditForm({
  ...
  const SaveEmpExpenseType = useApiRequest({});
  ...
  const submitHandler = ({ values, resetForm, setIsAddEditForm }) => {
    ...
    let payload = {
      intExpenseTypeId: singleData?.intExpenseTypeId
        ? singleData?.intExpenseTypeId
        : 0,
      strExpenseType: values?.strExpenseType,
  ...
  useEffect(() => {
    if (singleData?.intExpenseTypeId) {
      form.setFieldsValue({
        ...singleData,
      });
    }
          ...
          {isEdit && (
            ...
            >
              ...
              >
                ...
                >
                  <h6 className="title-item-name">Expense Type Activation</h6>
                  <p className="subtitle-p">
                    Activation toggle indicates to the particular Expense Type
...
//     if (singleData) {
//       const newRowData = {
//         expenseType: singleData?.strExpenseType,
...
//   useEffect(() => {
//     if (id) {
//       getGlobalExpenseTypeById(setSingleData, id, setLoading);
//     }
...
//     if (id) {
//       createExpenseType(
//         { ...payload, intExpenseTypeId: id },
//         setLoading,
//         callback
//       );
//     } else {
//       createExpenseType(
//         { ...payload, intExpenseTypeId: 0 },
//         setLoading,
//         callback
//       );
//     }
...
//                                   Expense Type Activation
//                                 </h6>
//                                 <p className="subtitle-p">
//                                   Activation toggle indicates to the particular
//                                   Expense Type status (Active/Inactive)
//                                 </p>
//                                 <FormikToggle
//                                   name="isActive"
//                                   color={
