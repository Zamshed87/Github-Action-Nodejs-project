        ...
        <Row gutter={[5, 2]} style={{ marginBottom: "-1.2rem" }}>
          <div className=" d-flex align-items-center">
            ...
            <div className="modal-body-txt">
              <h6 className="title-item-name">{singleData?.strReligion}</h6>
              <p className="subtitle-p">{"Religion"}</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="modal-body-txt">
              <h6 className="title-item-name">{singleData?.strReligionCode}</h6>
              <p className="subtitle-p">{"Religion Code"}</p>
            </div>
          </div>
        </Row>
      </PForm>
