    ...
    },
    {
      ...
      render: (data) => (
        <div className="d-flex justify-content-evenly align-items-center">
          ...
          {(data?.strInterviewStatus === "Completed" ||
            data?.strInterviewStatus === "Clearance" ||
          ...
          {data?.strInterviewStatus === "Assigned" && (
            ...
            >
              <PrimaryButton
                type="button"
                icon={<QuizIcon sx={{ color: "var(--primary-color)" }} />}
                className={"iconButton"}
                customStyle={{
                  height: "25px",
                  width: "25px",
                ...
                onClick={() => {
                  history.push(
                    "/SelfService/separation/applicationV2/interView",
                    {
                      data: data,
                    }
                  );
