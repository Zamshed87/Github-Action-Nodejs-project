...
export default function FinalSettlementRegenerate() {
  ...
  useEffect(() => {
    ...
    postFinalSettlementRegenarateData(
      `/FinalSettlement/ReGenerateFinalSettlement`,
      {
        IntFinalSettlementId: params?.settlementid,
        IntEmployeeId: params?.empid,
        IntSeparationId: params?.separationid,
      },
      (res) => {
      ...
      <form onSubmit={handleSubmit}>
        <div className="d-flex  justify-content-between">
          <div className="d-flex align-items-center">
            <BackButton />
            <h2>Final Settlement Regenerate</h2>
          </div>
          <PrimaryButton
        ...
        <Row gutter={[8, 8]} style={{ marginTop: "20px" }}>
          <Col span={9}>
            <Card
              ...
              loading={postFinalSettlementRegenarateLoading}
            >
              <Divider
                orientation="left"
