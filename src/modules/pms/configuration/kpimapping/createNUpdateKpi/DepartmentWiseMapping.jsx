...
const DepartmentWiseMapping = () => {
  ...
  const {
    ...
    validationSchema: validationSchema("dept"),
    onSubmit: () => {
      saveHandler(
        params,
        rowDto,
        ...
        <div className="table-card" ref={scrollRef}>
          <div className="table-card-heading heading pt-0">
            <BackButton
              title={
                params?.id
                  ? "Update KPI Mapping (Department Wise)"
                  : "Create KPI Mapping (Department Wise)"
              }
            />
...
export default DepartmentWiseMapping;
