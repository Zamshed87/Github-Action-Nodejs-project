...
import styles from "./departmentalTargetModal.module.css";
...
const DepartmentalTargetEntryModal = ({
  currentItem,
  setIsShowModal,
  ...
  const saveHandler = (values, cb) => {
    ...
    targetList?.forEach((item) => {
      payload.push({
        ...
        numAchivement: 0,
        intKpiforId: 2, // 1 for department
...
export default DepartmentalTargetEntryModal;
