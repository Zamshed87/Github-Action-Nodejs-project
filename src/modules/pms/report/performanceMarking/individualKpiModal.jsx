...
const IndividualKpiModal = ({ currentItem, setIsShowModal, getData }) => {
  ...
  useEffect(() => {
    if (currentItem) {
      getPreviousEntryData(
        `/PMS/GetTargetVsAchievementById?BusinessUnit=184&YearId=${currentItem?.yearId}&KpiForId=1&KpiForReffId=${currentItem?.employeeId}&objectiveId=${currentItem?.intStrategicParticularsID}&kpiId=${currentItem?.kpiId}&accountId=${intAccountId}`,
        (data) => {
          setTargetList(data);
        }
      );
  ...
  const saveHandler = (values, cb) => {
    ...
    targetList?.forEach((item) => {
      payload.push({
        ...
        intBusinessUnitId: currentItem?.intBusinessUnitId,
        intKpisId: currentItem?.kpiId,
        intEmployeeId: currentItem?.EmployeeId,
                ...
                <div className="row">
                  <div className="col-lg-12 pl-5 pr-5">
                    ...
                    <p
                      ...
                      className="mt-3 pb-3 employee_info"
                    >
                      <b> Name</b> : {currentItem?.EmployeeOnlyName}
                      <b> Enroll</b> : {currentItem?.EmployeeId}
                      <b> Designation</b> : {currentItem?.DesignationName}
                    </p>
                  </div>
