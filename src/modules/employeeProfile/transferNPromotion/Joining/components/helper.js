...
export const createPayload = (
  ...
  const tnpInfo = {
    ...
    strTransferNpromotionType: data?.strTransferNpromotionType,
    ...
    dteEffectiveDate: moment(data?.dteEffectiveDate).format("YYYY-MM-DD"),
    dteReleaseDate: data?.dteReleaseDate,
    intAttachementId:
      data?.intAttachementId ||
  ...
  const holidayAssign = {
    ...
    workplaceGroupId: data?.intWorkplaceGroupId,
    isActive: true,
    actionBy: employeeId,
  };
