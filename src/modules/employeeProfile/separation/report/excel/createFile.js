...
export const createFile = (excel, flag) => {
  ...
  excel?.sheets?.forEach((sheet) => {
    ...
    _sheet.getColumn("B").width = 25;
    _sheet.getColumn("C").width = 25;
    _sheet.getColumn("D").width = 17;
    _sheet.getColumn("E").width = 17;
    _sheet.getColumn("F").width = 20;
    _sheet.getColumn("G").width = 25;
    _sheet.getColumn("H").width = 22;
    _sheet.getColumn("J").width = 20;
    _sheet.getColumn("K").width = 20;
    _sheet.getColumn("L").width = 30;
    // generate row
    // eslint-disable-next-line no-unused-expressions
