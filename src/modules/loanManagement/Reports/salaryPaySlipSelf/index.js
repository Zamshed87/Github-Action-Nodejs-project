...
export default function SalaryPaySlipSelfReport() {
                      ...
                      {rowDto?.length > 0 &&
                        rowDto.map((data, index) => (
                          ...
                          >
                            {/* <td>{index+1}</td> */}
                            <td>
                              {data?.salaryGenerateHeaderObj?.strEmployeeName}[
                              {data?.salaryGenerateHeaderObj?.strEmployeeCode}]
                            </td>
                            <td>
                              {data?.salaryGenerateHeaderObj?.strDesignation}
                            </td>
                            <td>
                              {data?.salaryGenerateHeaderObj?.strDepartment}
                            </td>
                            <td>
                              {data?.salaryGenerateHeaderObj?.strEmploymentType}
                            </td>
                            <td className="text-right">
                              {dateFormatter(
                                data?.salaryGenerateHeaderObj?.dteJoiningDate
                              )}
                            </td>
                            <td>
                              {
                            ...
                            <td>
                              {data?.salaryGenerateHeaderObj?.strBankBranchName}
                            </td>
                            <td>
                              {data?.salaryGenerateHeaderObj?.strAccountName}
                            </td>
                            <td className="text-center">
                              {data?.salaryGenerateHeaderObj?.strAccountNo}
                            </td>
                            <td className="text-center">
                              {data?.salaryGenerateHeaderObj?.strRoutingNumber}
                            </td>
                            <td className="text-center">
                              {
                                data?.salaryGenerateHeaderObj
                            ...
                            <td className="text-right">
                              {data?.salaryGenerateHeaderObj?.numBasicSalary}
                            </td>
                            <td className="text-right">
                              {
                                data?.salaryGenerateHeaderObj
                            ...
                            <td className="text-right">
                              {data?.salaryGenerateHeaderObj?.numTotalPfbalance}
                            </td>
                            <td className="text-right">
