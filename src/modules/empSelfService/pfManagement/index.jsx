...
function PFSelfLanding() {
  ...
  const getData = () => {
    getViewPFWithYear(
      `/Employee/PfNGratuityLanding?IntAccountId=${orgId}&IntEmployeeId=${employeeId}`
    );
  };
