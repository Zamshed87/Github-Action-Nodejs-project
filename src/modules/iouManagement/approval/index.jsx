  ...
  useEffect(() => {
    ...
    applicationListData?.listData?.forEach((data) => {
      if (data?.selectCheckbox) {
        array.push({
          applicationId: data?.application?.intIouid,
    ...
    return [
      ...
      },
      {
        ...
        render: (_, record) => (
          <div className="d-flex align-items-center">
            <div>
              {dateFormatter(record?.application?.dteFromDate)}-
              {dateFormatter(record?.application?.dteToDate)}
            </div>
          </div>
        ),
        filter: false,
      ...
      },
      {
        ...
        render: (_, record) => (
          <div className="d-flex align-items-center">
              ...
              title={
                <div className="movement-tooltip p-1">
                  <div className="border-bottom">
                    ...
                    >
                      {record?.application?.strDiscription}
                    </p>
                  </div>
                </div>
              }
            ...
            <div className="ml-2">{record?.application?.numIouamount}</div>
          </div>
        ),
        filter: false,
        sorter: false,
      },
      {
        ...
        render: (_, record) => (
          <div className="d-flex align-items-center">
            <div>{record?.application?.numAdjustedAmount}</div>
          </div>
        ),
        filter: false,
        sorter: false,
      },
      {
        ...
        render: (_, record) => (
          <div className="d-flex align-items-center">
            <div>{record?.application?.numPayableAmount}</div>
          </div>
        ),
        filter: false,
        sorter: false,
      },
      {
        ...
        render: (_, record) => (
          <div className="d-flex align-items-center">
            <div>{record?.application?.numReceivableAmount}</div>
          </div>
        ),
        filter: false,
        sorter: false,
