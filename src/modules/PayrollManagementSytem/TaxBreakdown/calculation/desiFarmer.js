...
import { basedOnBasicPercentage, salaryBreakdownCreateNApply } from "../helper";

export const desiFarmerSetter = (
  values,
  dynamicForm,
  payload,
  setDynamicForm
...
export const desiFarmerCalculation = (
  employeeId,
  payload,
  singleData,
  state,
  ...
  const basicElement = modifyPayrollElementList.filter(
    (itm) => itm?.isBasic === true
  );
