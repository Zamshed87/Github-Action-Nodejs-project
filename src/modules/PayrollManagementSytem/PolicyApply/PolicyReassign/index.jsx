...
const PolicyReAssign = () => {
  ...
  const saveHandler = (values, cb) => {
    ...
    const payload = {
      strEntryType: "SalaryPolicyReAssign",
      intPolicyAssignId: 0,
      intAccountId: +orgId,
    ...
    postPolicyApply(
      ...
      "",
      true,
      "Policy re-assigned successfully!"
    );
  };
  //
  // filter landing
              ...
              <div className="table-card policy-bulk-assign-wrapper">
                <div className="table-card-heading">
                  <div className="d-flex align-items-center">
                    <BackButton title="Create Policy Re-Assign" />
                  </div>
                  <div>
                    <button
