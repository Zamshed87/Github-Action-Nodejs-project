...
export const probationCloseDateCustomDDL = [
  ...
  { value: 26, label: "1 Month", count: "1 month" },
  { value: 27, label: "2 Months", count: "2 month" },
  { value: 28, label: "3 Months", count: "3 month" },
  { value: 29, label: "4 Months", count: "4 month" },
  { value: 30, label: "5 Months", count: "5 month" },
  { value: 31, label: "6 Months", count: "6 month" },
